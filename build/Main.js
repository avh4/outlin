      ...
      return function () {
         ...
         {case "Entry":
            return function () {
                 ...
                 {case "InChild":
                    return function () {
                         var _v87 = A2(action,en,cur);
                         switch (_v87.ctor)
                         {case "NoChange":
                            return function () {
                                 var _v88 = A5($Core$Array.$do,
                                 InText(0),
                                 findLastCursor,
                                 doEntry(action),
                                 en._0.children,
                    ...
                    return function () {
                         ...
                         {case "Delete":
                            ...
                            return A2($Core$Action.Update,
                              ...
                              InInbox(_v104._1));}
                         _E.Case($moduleName,
                         "between lines 177 and 185");
                      }();
                    case "InText":
                    return function () {
                         var _v109 = A2(stringAction,
                         en._0.text,
                         cur._0);
                         switch (_v109.ctor)
                         {case "Delete":
                            ...
                            switch (_v109._0.ctor)
                              {case "::":
                                 switch (_v109._0._1.ctor)
                                   {case "::":
                                      switch (_v109._0._1._1.ctor)
                                        {case "[]":
                            ...
                            return A2($Core$Action.Update,
                              ...
                              InText(_v109._1));}
                         _E.Case($moduleName,
                         "between lines 161 and 173");
                      }();}
                 _E.Case($moduleName,
                 "between lines 160 and 192");
              }();}
         _E.Case($moduleName,
         "between lines 160 and 192");
      }();
