...
Elm.Keys.make = function (_elm) {
   ...
   var fromMeta = function (code) {
      return function () {
         var _v2 = charFromCode(code);
         switch (_v2.ctor)
         {case "Just":
            return CommandCharacter(_v2._0);
            case "Nothing":
            return function () {
                 var _v4 = keyFromCode(code);
                 switch (_v4.ctor)
                 {case "Just":
                    return Command(_v4._0);
                    case "Nothing":
   ...
   var fromShift = function (code) {
      return function () {
         var _v6 = keyFromCode(code);
         switch (_v6.ctor)
         {case "Just":
            return Shift(_v6._0);
            case "Nothing":
            return function () {
                 var _v8 = charFromCode(code);
                 switch (_v8.ctor)
                 {case "Just":
                    return Unrecognized(A2($Basics._op["++"],
                      "Shift-",
   ...
   var fromDowns = function (code) {
      return function () {
         ...
         return Unrecognized($Basics.toString(code));
      }();
   };
...
Elm.Outline.Entry.make = function (_elm) {
   ...
   A2($Json$Decode._op[":="],
   "inbox",
   $Json$Decode.list(lazy(function (_v116) {
      return function () {
         return decoder;
      }();
   }))),
